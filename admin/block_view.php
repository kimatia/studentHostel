                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <tr class="odd gradeX">
                                            ...
                                            <td align="center"><a title="Delete" href='block_delete.php?id=<?php echo $row["id"];?>' onclick="return confirm('are you sure want to delete')"><i class="glyphicon glyphicon-trash"></i></a></td>
                                            <td align="center"><a title="Update" href='block_edit.php?id=<?php echo $row["id"];?>'><i class="glyphicon glyphicon-pencil"></i></a></td>
                            </tr>
